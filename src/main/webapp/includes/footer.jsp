        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                   ...
                   <p> <a href="https://www.instagram.com/accounts/login/?next=%2Fredbusindia%2F" class="text-white"><i class="fab fa-instagram fa-2x"></i></a>
                    <a href="#" class="text-white"><i class="fab fa-linkedin fa-2x"></i></a></p>
                </div>
            </div>
