	...
	<div class="container mt-5 d-flex justify-content-center">
        <div class="card w-50">
            <div class="card-header text-center">
                <h2><i class="fas fa-bus"></i>Update route details</h2>
            </div>
            <div class="card-body">
            <form action="<c:url value="/routecontroller/update?id=${id}"/>" method="post" id="registrationForm">
            <div class="form-group">
                <label for="source"><i class="fa-solid fa-map-marker-alt"></i> Source:<span> *</span></label>
                <input type="text" class="form-control" id="source" name="source" placeholder="Enter the source" value="${source}" required>
                <div class="error" id="sourceError"></div>
            </div>
            <div class="form-group">
                <label for="destination"><i class="fa-solid fa-flag-checkered"></i> Destination:<span> *</span></label>
                <input type="text" class="form-control" id="destination" name="destination" placeholder="Enter the destination" value="${destination}" required>
                <div class="error" id="destinationError"></div>
            </div>
            <div class="form-group">
                <label for="distance"><i class="fas fa-clipboard"></i> Distance:<span> *</span></label>
                <input type="number" class="form-control" id="distance" name="distance" placeholder="Enter the distance" oninput="calculatePrice()" value="${distance}" required>
